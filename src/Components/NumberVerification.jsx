...
function NumberVerification({setisNumberVerification,setMobileNumber}) {
  ...
  const { setuprecaptcha} = UsedbContext();
  ...
  const verifyotpandlogin = async () => {
    ...
    //   const authentication = await MobileAuthentication(phoneNumber);
    //   if (authentication) {
          ...
          >
            ...
            <Text ml={'auto'}>{item.code}</Text>
                   ...
                   {error&&<Text className="text-red-700">Invalid Phone Number</Text>}
                    ...
                    <Text color={'teal'} cursor={'pointer'}>Link with Qr code</Text>
